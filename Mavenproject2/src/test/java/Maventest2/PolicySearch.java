...
public class PolicySearch {
		...
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[3]/div[1]/div[2]/input[1]")).sendKeys("test55555");
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[3]/div[1]/div[5]/button[1]")).click();
		
		Thread.sleep(5000);
	  WebElement search_results = driver.findElement(By.className("css-18lzphb"));

	  String search_result_text = search_results.getText();
	  if(search_result_text.contains("TEST") && !search_result_text.contains("No Rows To Show")) {
